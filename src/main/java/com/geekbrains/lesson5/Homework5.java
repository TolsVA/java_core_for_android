...
public class Homework5 {
    ...
    public static String lainSurname = "Тягай, Александров, Яковенко, Яковлев, Ершов, Лядунки, Железа, Белоусов, Захаров, Селезнёв, " +
            "Кононов, Кириленко, Горбунов, Клич ко, Максимов, Повал ий, Князев, Симонов, Орлов, Семёнов, Григорьев, Быков, Зимин, " +
            "Геле тей, Ба чей, Красильников, Королёв, Рублевский, Куленко, Фомичёв";
    public static String lainFirstName = "Конрад, Филипп, Шерлок, Харитон, Тимофей, Иосиф, Устин, Зенон, Чарльз, Юлиан, Шарль, Леон, " +
            "Йонас, Артём, Йосип, Ждан, Абрам, Лоренсо, Вадим, Пифос, Герасим, Эдуард, Гордей, Назар, Бронислав, Оскар, Гордей, " +
            "Харитон, Фёдор, Юлий";
    public static String lainPatronymic = "Дмитриевич, Борисович, Викторович, Владимирович, Сергеевич, Львович, Петрович, Андреевич, " +
            "Вадимович, Ахимович, Фёдорович, Эдуардович, Андреевич, Платонович, Григорьевич, Богданович, Станиславович, Алексеевич, " +
            "Максимович, Станиславович, Михайлович, Валериевич";
    public static String lainPosition = "ген. Директор, Директор, зам. Директора, гл. Бухгалтер, Бухгалтер, гл. Инженер, Инженер, " +
            "Механик, Бригадир, Слесарь, Плотник, Стропальщик, Крановщик, Кладовщик, Водитель, Грузчик, Сторож, Столяр, Геодезист, " +
            ...
            if (a >= 20 && a <= 65) {
                ...
                do {
                    ...
                    if (!y.equals("-") || !y.equals("+")) {
                        System.out.println(y + " - Данные значения не соответствуют ожидаемым введите плюс - (+)  или минус - (-)");
                        y = se.nextLine();
                        if (y.equals("-")) {
                            arr[1] = -1;
                            return arr;
